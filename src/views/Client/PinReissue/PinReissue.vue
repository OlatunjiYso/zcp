...
methods:{
 ...
 const result = await axios.get(this.getUrl2 + 'api/CardPin/allrequest/'+companyId.companyId);
  ...
  async fetchApprovalRequests(){
        this.approvalLoader = true
         const companyId = JSON.parse(localStorage.getItem("user-mfb"))
 const result = await axios.get(this.getUrl2 + 'api/CardPin/pendingapprovals/'+companyId.companyId)
      ...
      async fetchRejectedRequests(){
          this.RejectLoader = true
           const companyId = JSON.parse(localStorage.getItem("user-mfb"))
 const result = await axios.get(this.getUrl2 + '/api/CardPin/rejectedrequest/'+companyId.companyId)
