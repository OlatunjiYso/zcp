<template>
 ...
 <div class="content-header">Pending Pin Reissue</div>
       ...
       const user = JSON.parse(localStorage.getItem("user-mfb"))
        const formData = {
         ...
         try {
             ...
             const response = await axios.post(this.getUrl2 + 'api/CardPin/approvepinreissue',formData)
       ...
       const user = JSON.parse(localStorage.getItem("user-mfb"))
        const formData = {
         ...
         try {
             ...
             const response = await axios.post(this.getUrl2 + 'api/CardPin/rejectpinreissue',formData)
            if(response.status == 200 && response.data == true){
               this.loader = false;
               this.status = true;
               this.state = 'success';
