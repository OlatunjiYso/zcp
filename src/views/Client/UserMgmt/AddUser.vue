            ...
            <div className="form-flex">
              ...
              <div className="form-flex-col">
                ...
                <input
                  ...
                  required
                />
                <p v-show="error" style="color: red; font-size: 12px">
              ...
              <div className="form-flex-col">
                ...
                <label
                  ...
                  "
                  for="cash"
                  >By setting up this new User, we confirm that the User is duly
                  authorized by the Company to create/initiate/approve requests
                  on the ZCard Portal on behalf of our Company. We hereby fully
                  indemnify Zenith Bank Plc (“the Bank”) against any and all
                  claims, demands, actions, suits, losses, costs, charges,
                  expenses, damages, penalties and liabilities whatsoever which
                  the Bank may incur by reason of or in connection with the
                  setup of the User as a Super Admin, Maker or Checker on the
                  ZCard portal.</label
                >
              </div>
            </div>
