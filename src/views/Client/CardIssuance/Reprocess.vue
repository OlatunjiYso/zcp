  ...
  <form @submit.prevent="sendRequest">
    <div class="form-flex">
      ...
      <div class="form-flex-col-3">
        ...
        <input v-model="requestData.middleName" type="text" class="app-text-field w-input" placeholder="Type Here" />
      </div>
      <div class="form-flex-col-3">
      ...
      <div class="form-flex-col-3">
        ...
        <input v-model="requestData.email" type="email" class="app-text-field w-input" placeholder="Type Here" />
      </div>
      <div class="form-flex-col-3">
      ...
      <div class="form-flex-col-3" v-show="requestData.idCardTypeCode != '02' && requestData.idCardTypeCode != '04'">
        <label class="login-label">Expiry Date<span style="color:red">*</span></label>
        <input v-model="requestData.expiryDateOfDoc"  :min="validateExpiry" type="date" class="app-text-field w-input" placeholder="Type Here" />
      </div>
      <div class="form-flex-col-3">
