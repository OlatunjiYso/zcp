           ...
           <div v-else>
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <td class="app-table2-data"> <input v-model="reason[result.id]" type="text" class="app-input-search w-input" placeholder="Type here" id="name"></td>
  ...
  async  Approve(result){
       ...
       const user = JSON.parse(localStorage.getItem("user-mfb"))
         ...
         try {
             ...
             const response = await axios.post(this.getUrl2 + 'api/CardParameterization/approve',formData)
      ...
      async  Decline(result){
       ...
       const user = JSON.parse(localStorage.getItem("user-mfb"))
         ...
         try {
             ...
             const response = await axios.post(this.getUrl2 + 'api/CardParameterization/reject',formData)
           if(response.status == 200 && response.data == true){
               this.loader = false;
               this.status = true;
               this.state = 'success';
