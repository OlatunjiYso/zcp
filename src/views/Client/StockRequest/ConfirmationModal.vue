...
export default {
  ...
  computed: {
    ...
    confirmationMsg: function () {
      ...
      const declineMsg = `You are about to decline a stock request of ${noOfCards} nos of ${
        typeOfCard || ""
      }, each on a Limit of ₦${cardLimit}.`;
      const approveMsg = `You are about to approve a stock request of ${noOfCards} nos of ${
        typeOfCard || ""
      }, each on a Limit of ₦${cardLimit}.`;
      const acknowledgedMsg = `By clicking on 'Continue', you acknowledge that you have received ${noOfCards} nos of ${
        typeOfCard || ""
      }, Credit Cards.`;
      if (intent == "decline") return declineMsg;
      if ((intent == "acknowledgement")) return acknowledgedMsg;
      return approveMsg;
    },
  },
