<template>
 ...
 <input v-model="searchQuery" type="text" class="app-input-search w-input" placeholder="Account Number" id="name">         
        ...
        <form className="app-table-select">
              <input placeholder="Reason" v-show="multiAction" v-model="reason[0]"  style="margin-right:20px;width:40%" type="text" className="app-modal-form-field w-input"/>
                        ...
                        <tbody>
                            ...
                            <td class="app-table2-data">{{result.productCode}}</td>
                             <td class="app-table2-data">
                               <input v-show="singleAction" v-model="reason[result.id]" type="text" class="app-input-search w-input" placeholder="Type here" id="name">
                            </td> 
                              <td class="app-table2-data">
