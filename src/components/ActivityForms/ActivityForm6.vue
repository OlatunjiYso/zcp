<template>
 ...
 <div class="content-header">Pin Reissue Request</div>
           ...
           <div v-else>
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <div @click="PinReissue(result)" style="cursor:pointer" class="table-btn">Pin Reissue<span class="table-button-icon"></span></div>
                            </td> 
                        </tr>                  
                    </tbody>
...
this.status = false;
   ...
   this.cardData = response.data
       ...
       const user = JSON.parse(localStorage.getItem("user-mfb"))
         ...
         try {
             const response = await axios.post(this.getUrl2 + 'api/CardPin/initialandreprocesspinreissue',form)
