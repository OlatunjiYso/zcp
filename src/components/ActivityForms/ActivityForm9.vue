           ...
           <div v-else>
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <div @click="Deactivate(result)" style="cursor:pointer" class="table-btn">Deactivate<span class="table-button-icon"></span></div>
                            </td> 
                        </tr>
   ...
   this.cardData = response.data
       ...
       const user = JSON.parse(localStorage.getItem("user-mfb"))
         ...
         try {
             ...
             const response = await axios.post(this.getUrl2 + 'api/cardDeactivatedeDeactivate/deactivation',form)
